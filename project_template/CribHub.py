...
if __name__ == '__main__':
    inst = CribHub()
    query = "wall street"
    rel = [['airbnb', '3231803'], ['airbnb', '10160215'], ['airbnb', '6887755'], ['airbnb', '14790550']]
    irr = [['airbnb', '785097'], ['airbnb', '11656750'], ['airbnb', '13698623']]
    roc_results = inst.rocchio(query, rel, irr)
    print (roc_results['neighborhood_ranking'][query][:10])
